        ...
        oneOf: [
          {
            ...
            test: /\.js$/,
            use: [
              // 'thread-loader', // 开启多进程打包(进程开启与通信还是有开销的)
              // {
              //   loader: 'thread-loader',  // 开启多进程打包(进程开启与通信还是有开销的)
              //   options: {
              //     workers: 2 // 启动2个进程(默认是CPU核数-1)
              //   }
              // },
              {
